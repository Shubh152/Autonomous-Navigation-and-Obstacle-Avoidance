...
def generate_launch_description():
    ...
    slam_launch_path = PathJoinSubstitution([pkg_slam, 'launch', 'online_async_launch.py'])
    ...
    return launch.LaunchDescription([
        ...
        #     launch_arguments={
        #         'use_sim_time' : "True",
        #         'params_file' : '/home/shubh/diff_drive_car/diff_car_model/config/slam_toolbox.yaml'
        #     }.items(),
        # ),
